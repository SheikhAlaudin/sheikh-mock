...
export const SESSIONS = [
  {id:'all',name:'Full Interview',sub:'All 71 questions',col:'#3B82F6',f:null},
  {id:'d1',name:'Day 1 · JS Foundations',sub:'30 questions · Core JS + Arrays + Objects',col:'#F59E0B',f:1},
  {id:'d2',name:'Day 2 · JS Advanced + React',sub:'20 questions',col:'#10B981',f:2},
  {id:'d3',name:'Day 3 · React Advanced + Build',sub:'21 questions',col:'#8B5CF6',f:3},
];
